...
id0082$(E): src/id0082.c libeuler$(A)
	$(CC) $(CFLAGS) $< -o $@ $(LEULER) $(LM)

id0083$(E): src/id0083.c libeuler$(A)
	$(CC) $(CFLAGS) $< -o $@ $(LEULER) $(LM)

id0084$(E): src/id0084.c libeuler$(A)
	$(CC) $(CFLAGS) $< -o $@ $(LEULER) $(LM)

id0085$(E): src/id0085.c libeuler$(A)
	$(CC) $(CFLAGS) $< -o $@ $(LEULER) $(LM)

id0086$(E): src/id0086.c libeuler$(A)
	$(CC) $(CFLAGS) $< -o $@ $(LEULER) $(LM)
